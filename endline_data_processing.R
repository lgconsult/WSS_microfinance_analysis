...
#our treatment variable in the 'Finaldata' dataset is 'ic6' i.e. is your loan approved?
...
endline_dataforanalysis <- endline_data_subset[,c(16,25,73,74,75,77,367,246,424,58),]


# Add NA to blank columns
endline_dataforanalysis[endline_dataforanalysis == ""] <- NA
...
#endline_data_omit <- na.omit(endline_dataforanalysis)
...
write.csv(endline_dataforanalysis, "C:/Users/luke.gates/Castalia/endline_dataforanalysis_final.csv", row.names=FALSE)
